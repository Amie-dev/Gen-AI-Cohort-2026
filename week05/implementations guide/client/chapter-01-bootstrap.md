# Client Chapter 1 — Project Bootstrap & Application Shell

## 1. Goal & Outcome
- **Goal**: Build core application utilities, reverse proxy routing, TanStack Query provider, Next Themes provider, and global root layout.
- **Student Outcome**: Global state, API proxy layer, theme engine, and page wrapper layout configured for the application.
