# Client Chapter 6 — Multi-Channel Add Source Dialog & File Upload UI

## 1. Goal & Outcome
- **Goal**: Implement multi-tab dialog interface supporting PDF drag-and-drop upload, Firecrawl website scraping, YouTube video URL importing, and raw markdown note entry.
- **Student Outcome**: Unified, user-friendly source ingestion modal with tabbed input channels and live processing triggers.
