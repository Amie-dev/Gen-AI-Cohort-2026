# Master Chapter 0 — 00 Overview Setup

## 1. Chapter Overview & Goal
- **Server Goal**: Set up the Node.js TypeScript ESM backend project structure, dependencies, and environment configuration.
- **Client Goal**: Set up the Next.js 16 App Router client project with Tailwind CSS v4, TypeScript, ESLint, Shadcn UI components, and build configurations.
...
3. Verify API proxy routing and test features covered in Chapter 0.
