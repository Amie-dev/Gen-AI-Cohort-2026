 ...
 * Powered by Google Gemini API & AlphaGo Monte Carlo Tree Search (MCTS) PageIndex Architecture.
 */
export class AgenticTreeSearchEngine {
   ...
   * Uses Gemini API reasoning when configured, with local scoring fallback.
   * @param {string} query 
  ...
  async selectBestBranch(query, candidateNodes) {
    // Try Gemini API evaluation first
