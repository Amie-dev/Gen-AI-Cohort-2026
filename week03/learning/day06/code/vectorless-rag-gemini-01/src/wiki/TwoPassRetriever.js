...
/**
 * TwoPassRetriever implements Andrej Karpathy's Two-Pass Retrieval Algorithm for LLM Wikis with Google Gemini API support.
 */
export class TwoPassRetriever {
  ...
  async evaluateCatalogWithGemini(query, catalog) {
    ...
    const systemInstruction = "You are an AI Wiki Librarian. Given a user query and catalog file summaries, select the single best file path. Respond ONLY with JSON format: {\"selectedFilePath\": \"<path>\", \"reasoning\": \"<short_explanation>\"}.";
